...
// be used.
func New(raft Raft, delegate Delegate, options ...Option) *Autopilot {
	a := &Autopilot{
		raft:     raft,
		delegate: delegate,
		promoter: DefaultPromoter(),
...
// RemoveDeadServers will trigger and immediate removal of dead/failed servers.
...
// Reconcile will trigger an immediate round of promotions and demotions.
